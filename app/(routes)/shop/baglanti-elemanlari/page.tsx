...
import { baglantiElemanlari, ProductType } from '@/constans'
...
const BaglantiElemanlariPage = () => {
  ...
  const productTypes: Record<string, (product: ProductType) => boolean> = {
    'Tümü': () => true,
    'Cıvatalar': (product: ProductType) => product.title.includes('Cıvata') || product.description.includes('cıvata'),
    'Somunlar': (product: ProductType) => product.title.includes('Somun') || product.description.includes('somun'),
    'Vidalar': (product: ProductType) => product.title.includes('Vida') || product.description.includes('vida'),
    'İmbuslar': (product: ProductType) => product.title.includes('İmbus') || product.description.includes('imbus'),
    'Dübeller': (product: ProductType) => product.title.includes('Dübel') || product.description.includes('dübel')
  }
  
  // Filter products based on selected filter and search term
  const filteredProducts = baglantiElemanlari.filter(product => {
    ...
    <div className="min-h-screen bg-[#1a1f2b] py-12 pt-28">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Image 
            src="/slider/civata-banner.jpg" 
            alt="Bağlantı Elemanları" 
            fill 
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center p-8">
            ...
            >
              ...
              >
                Cıvata, somun, vida gibi bağlantı elemanları ve çözümleri
              </motion.p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Bağlantı Elemanları ve Kullanım Alanları</h2>
          <p className="mb-4">
            Bağlantı elemanları, endüstriyel ve günlük kullanımda parçaları birbirine sabitlemek için kullanılan temel mekanik bileşenlerdir. Cıvata, somun, vida, perçin gibi çeşitleri olan bağlantı elemanları, dayanıklılık ve güvenlik açısından hayati öneme sahiptir.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Yüksek Dayanım</h3>
              <p>Farklı malzeme ve kaplama seçenekleriyle, zorlu ortam koşullarına dayanıklı bağlantı elemanları.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Çeşitli Boyutlar</h3>
              <p>Her türlü uygulama için farklı boyut ve özelliklerde geniş ürün yelpazesi.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Endüstriyel Standartlar</h3>
              <p>Uluslararası standartlara uygun üretilmiş, kalite ve güvenlikten ödün vermeyen bağlantı elemanları.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {['/slider/skf.png', '/slider/loctite.png', '/slider/best.png', '/slider/iscar.png', '/slider/emes.png'].map((brand, index) => (
              <motion.div
                key={index}
...
export default BaglantiElemanlariPage 