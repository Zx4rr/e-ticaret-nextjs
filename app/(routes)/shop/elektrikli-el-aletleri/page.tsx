...
const ElektrikliElAletleriPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1f2b] py-12 pt-28">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center p-8">
            ...
            >
              ...
              >
                Profesyonel ve amatör kullanım için elektrikli el aletleri
              </motion.p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Elektrikli El Aletleri ve Kullanım Alanları</h2>
          <p className="mb-4">
            Elektrikli el aletleri, hem profesyonel hem de hobi amaçlı kullanımlar için tasarlanmış pratik ve güçlü çözümlerdir. İnşaat, tamirat, ahşap işleme ve metal işleme gibi çeşitli alanlarda ihtiyacınız olan her türlü elektrikli aleti burada bulabilirsiniz.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Profesyonel Ekipmanlar</h3>
              <p>Endüstriyel standartlara uygun, uzun süreli yoğun kullanım için tasarlanmış profesyonel elektrikli aletler.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Hobi ve Ev Kullanımı</h3>
              <p>Ev projeleri ve hobi çalışmaları için ideal, kullanımı kolay ve ekonomik elektrikli el aletleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Geniş Aksesuar Yelpazesi</h3>
              <p>Her türlü işlem için gereken uç, disk ve aksesuar çeşitleri ile elektrikli aletlerinizin kullanım alanını genişletin.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
              Bu kategoriye ait ürünler yakında eklenecektir. Şu anda elektrikli el aletleri ürün grubumuzu güncelliyoruz. Kısa süre içinde en kaliteli markalardan oluşan geniş ürün yelpazemiz ile hizmetinizde olacağız.
            </motion.p>
...
export default ElektrikliElAletleriPage 