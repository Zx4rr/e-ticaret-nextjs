    ...
    <div className="min-h-screen bg-[#1a1f2b] py-12 pt-28">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Image 
            src="/slider/havali-alet-banner.jpg" 
            alt="Havalı El Aletleri" 
            fill 
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center p-8">
            ...
            >
              ...
              >
                Basınçlı hava ile çalışan havalı el aletleri ve özellikleri
              </motion.p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Havalı El Aletleri ve Kullanım Alanları</h2>
          <p className="mb-4">
            Havalı el aletleri, basınçlı hava ile çalışan, elektrikli aletlere göre daha hafif ve yüksek güç/ağırlık oranına sahip profesyonel ekipmanlardır. Otomotiv, endüstriyel üretim ve ağır sanayi alanlarında tercih edilen bu aletler, yüksek verimlilik ve uzun ömür sunar.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Yüksek Tork Gücü</h3>
              <p>Elektrikli aletlere göre daha yüksek tork ve güç sağlayan, ağır işler için ideal havalı el aletleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Endüstriyel Dayanıklılık</h3>
              <p>Sürekli ve yoğun kullanım için tasarlanmış, ısınma problemi olmayan dayanıklı aletler.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Geniş Uygulama Alanı</h3>
              <p>Somun sıkma, delme, kesme, taşlama ve boyama gibi çeşitli işlemler için özel havalı el aletleri.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
              Bu kategoriye ait ürünler yakında eklenecektir. Şu anda havalı el aletleri ürün grubumuzu güncelliyoruz. Kısa süre içinde profesyonel kalitede geniş ürün yelpazemiz ile hizmetinizde olacağız.
            </motion.p>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {['/slider/skf.png', '/slider/best.png', '/slider/oerlikon.png', '/slider/iscar.png', '/slider/fag.png'].map((brand, index) => (
              <motion.div
                key={index}
...
export default HavaliElAletleriPage 