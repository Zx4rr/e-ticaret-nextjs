  ...
  return (
    <div className="min-h-screen bg-[#1a1f2b] py-12 pt-28">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center p-8">
            ...
            >
              ...
              >
                Hidrolik ve Pnomatik Çeşitleri
              </motion.h1>
              <motion.p 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Profesyonel ve amatör kullanım için hidrolik ve pnomatik çeşitleri
              </motion.p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Hidrolik ve Pnomatik Çeşitleri ve Kullanım Alanları</h2>
          <p className="mb-4">
            Hidrolik ve pnomatik çeşitleri, hem profesyonel hem de hobi amaçlı kullanımlar için tasarlanmış pratik ve güçlü çözümlerdir. İnşaat, tamirat, ahşap işleme ve metal işleme gibi çeşitli alanlarda ihtiyacınız olan her türlü hidrolik ve pnomatik çeşitlerini burada bulabilirsiniz.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Profesyonel Ekipmanlar</h3>
              <p>Endüstriyel standartlara uygun, uzun süreli yoğun kullanım için tasarlanmış profesyonel hidrolik ve pnomatik çeşitleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Hobi ve Ev Kullanımı</h3>
              <p>Ev projeleri ve hobi çalışmaları için ideal, kullanımı kolay ve ekonomik hidrolik ve pnomatik çeşitleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Geniş Aksesuar Yelpazesi</h3>
              <p>Her türlü işlem için gereken uç, disk ve aksesuar çeşitleri ile hidrolik ve pnomatik çeşitlerinizin kullanım alanını genişletin.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
            Bu kategoriye ait ürünler yakında eklenecektir. Şu anda hidrolik ve pnomatik çeşitleri ürün grubumuzu güncelliyoruz. Kısa süre içinde en kaliteli markalardan oluşan geniş ürün yelpazemiz ile hizmetinizde olacağız.
            </motion.p>
...
export default HidrolikPnomatikPage 