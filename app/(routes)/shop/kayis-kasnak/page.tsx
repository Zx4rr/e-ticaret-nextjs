    ...
    <div className="min-h-screen bg-[#1a1f2b] py-12 pt-28">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Image 
            src="/slider/kayis-kasnak-banner.jpg" 
            alt="Kayış Kasnak" 
            fill 
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center p-8">
            ...
            >
              ...
              >
                Makinalarda güç aktarımı için kullanılan kayış ve kasnak çeşitleri
              </motion.p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-semibold mb-4">Kayış Kasnak Sistemleri ve Kullanım Alanları</h2>
          <p className="mb-4">
            Kayış ve kasnak sistemleri, makinelerde güç aktarımını sağlayan temel mekanik bileşenlerdir. Farklı tipte kayışlar ve kasnaklar çeşitli endüstriyel uygulamalarda yaygın olarak kullanılmaktadır.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Yüksek Verimlilik</h3>
              <p>Minimum enerji kaybı ile maksimum güç aktarımı sağlayan kasnak kayış sistemleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Geniş Uygulama Alanı</h3>
              <p>Farklı endüstriyel sektörlere yönelik özel tasarlanmış kayış kasnak çözümleri.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Uzun Ömür</h3>
              <p>Dayanıklı malzemelerden üretilmiş, uzun süreli kullanıma uygun kayış ve kasnaklar.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
              Bu kategoriye ait ürünler yakında eklenecektir. Şu anda kayış kasnak ürün grubumuzu güncelliyoruz. Kısa süre içinde geniş ürün yelpazemiz ile hizmetinizde olacağız.
            </motion.p>
...
export default KayisKasnakPage 